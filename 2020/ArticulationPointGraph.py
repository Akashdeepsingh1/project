...
obj = Solution()
print (obj.adjacencyGraph (edges, numNodes, numEdges))
...
obj1 = Solution()
print (obj1.adjacencyGraph (edges1, numNodes1, numEdges1))

numNodes2 = 4
numEdges2 = 4
edges2 = [[0,1],[1,2],[2,3]]
obj2 = Solution()
print(obj2.adjacencyGraph(edges2,numEdges2,numNodes2))
...
obj3 = Solution()
print(obj3.adjacencyGraph(edges3,numNodes3,numEdges3))